...
implemented. Number-, temporal-, and selection-field validation are also editable. Existing-field type
conversion, boolean validation, and AI editing are not.
...
- Add remaining boolean validation editing
