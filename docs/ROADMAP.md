...
dashboard, health sample, owner draft create/load/save, and atomic publication are implemented. The form builder
and AI generation are not.
...
- Add structured section, field, option, and validation editing
